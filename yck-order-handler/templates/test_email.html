...
<p><strong>(1) Submit the barcode (order number) of this voucher and your passport. <br>(2) Also, if you need to make outgoing voice/texts, charge the amount for outgoing voice/texts.<br>
Once your passport verification and charging (if needed) are complete, you will receive your SKT SIM card.</strong></p><br>
<p class="red-text">※ You must pay with your credit card that can be used in Korea.<br> 
※ If there are many customers waiting, you may be asked to charge the amount for outgoing voice/texts through online.</p><br>
</div>
...
Rental contract number / eSIM 010 phone number (This information will be provided at the SKT roaming center when you pick up your SIM card)</p><br>
