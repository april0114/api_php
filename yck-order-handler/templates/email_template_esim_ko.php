...
<table style="border-collapse: collapse; width: 100%; table-layout: fixed;">
  ...
  ※eSIM Profile을 삭제할 경우, 신규 eSIM을 주문해야만 사용할 수 있습니다.</p>
</div>
...
<div class="inline-block-fix">
<p class="red-text">(※ Data 만 이용하실 분은 아래 절차가 필요 없습니다)</p><br>
<p>미국에서 eSIM을 먼저 설치하시고 한국 도착 후, 공항의 SKT 로밍센터를 방문해 주세요.</p><br>
<p>1. QR 코드 이메일(주문번호/렌털 계약 번호/ eSIM 010 전화번호) 제출</p><br>
<p>2. 본인 여권(여권 정보 진위 여부 확인) 제출</p><br>
<p>3. 음성/문자 발신용 금액 충전 (한국에서 사용 가능한 본인 신용카드로 결제)</p>
</div>

<div class="section-title">■ 음성/문자 발신용 금액 충전</div>
<div class="inline-block-fix">
<p>※ 음성/문자 발신은 금액 충전 시 이용이 가능하며 음성/문자 수신은 무료로 이용이 가능합니다.</p></div>
...
<div class="inline-block-fix">
<p>※ Data 만 이용하실 분은 여권 정보 진위 여부 확인이 필요 없습니다.</p><br>
<p style="color: red;">※ 대한민국 여권 보유자는 여권 정보 진위 여부 확인을 온라인에서 이용할 수 없습니다.</p><br>
<p>한국 출입국 관리소 통과 이후에, 매일 8시부터 22시까지 확인 가능합니다. </p><br>
<p>
...
<p>① 로그인 정보 입력:<br>
렌털 계약 번호 / eSIM 010 전화번호 (이 정보는 QR 코드 이메일에 제공됩니다)</p><br>

<p>② 여권정보 입력:<br>
성 / 이름 / 여권번호 / 생년월일 / 국적 (여권상 표시와 동일해야 합니다)</p><br>
</div>

<div class="section-title">■ 온라인 음성/문자 발신용 금액 충전 방법 </div>
<div class="inline-block-fix">
<p style="color: red;">※ 여권 정보 진위 여부 확인을 마치신 고객님에 한하여 이용할 수 있습니다.</p><br>
