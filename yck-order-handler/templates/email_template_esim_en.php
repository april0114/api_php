...
<p class="red-text">※ If you only need data, the following steps are not required./p>
  <p>Before arriving in Korea, please install the eSIM on your phone.<br>Then, visit the SKT roaming center at the airport.</p>


<p>1. Present the QR code email (order number /rental contract number / eSIM 010 phone number) </p>
 <p>2. Submit your passport to verify passport information.</p>
...
<p>※ For those using data only, passport information verification is not required./p>
<p style="color: red;">※ A passport issued by the Republic of Korea cannot be used cannot use online passport information verification.</p>
<p>Online passport information verification is available daily from 8:00 AM to 10:00 PM after passing through Korean immigration. </p>
<p>
...
<p style="color: red;">※ Only customers who have completed passport information verification can charge online./p>
