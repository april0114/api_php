...
<body>
  ...
  <p><strong>Thank you very much for ordering the Y CONNECT KOREA SKT eSIM.<br><br>
      ...
      Once your order is complete, you should receive an email containing a QR code separately from this installation
      guide email.
      .<br>

      <p class="highlight">If you do not receive the QR code email (in English) from our Korean partner within 24 hours
      ...
      <p><strong>2. If you still do not receive the QR code after checking the above 1,<br>please send an email to
          <a href="mailto:contact@yconnectkorea.com">contact@yconnectkorea.com</a>with QR Code Not Received, and include
          your name, phone number, and order number. We will process your request immediately.</strong></p>


      <div?php $raw_date=$mail_data['arrival_date'] ?? '' ; $formatted_date='' ; try {
        $date=DateTime::createFromFormat('d/m/Y', $raw_date); if ($date !==false) { $formatted_date=$date->
        format('Y-m-d');
        }
        } catch (Exception $e) {
        ...
        <table style="border-collapse: collapse; width: 100%; table-layout: fixed;">
          <tr>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">Last Name /
              First Name</td>
          ...
          <tr>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">Mobile Number
            </td>
          ...
          <tr>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">Mobile Model
              Name</td>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">
              <?= htmlspecialchars($mail_data['device_model']) ?></td>
          </tr>
          <tr>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">Arrival Date
              in Korea</td>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">
          ...
          <tr>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle; color: red;">
              Pickup / Passport Verification / Charge</td>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle; color: red;">
              <?= htmlspecialchars($mail_data['pickup_location']) ?></td>
          </tr>
          <tr>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">Usage Days
            </td>
            <td style="border: 1px solid #000; padding: 12px; text-align: center; vertical-align: middle;">
        ...
        <div class="inline-block-fix">
          <p>※ This eSIM QR codes can be scanned within one year after the order and it cannot be scanned after one
            year.<br>
        ...
        <div class="inline-block-fix">
          ...
          <p>Before arriving in Korea, please install the eSIM on your phone.<br>Then, visit the SKT roaming center at
            the airport.</p><br>
          ...
          <p>3. Charge the amount for outgoing voice/texts (You must pay with your credit card that can be used in
            Korea).</p>
        </div>
        ...
        <div class="inline-block-fix">
          <p>※ Outgoing voice/text can be used when the amount is charged, and incoming voice/text is free of charge.
          </p>
        </div>
        ...
        <div class="box-link" style="text-align: left; font-weight: bold;">
          <a href="https://yconnectkorea.com/contact/#03" target="_blank" style="color: black; text-decoration: none;">
            View Details: SKT roaming center
          </a>
        </div>

        <!--■ 온라인 여권 정보 진위 여부 확인 (외국 여권 소지자만 가능)-->
        <div class="section-title">■ Online Passport Information Verification (Only Available for Foreign Passport
          Holders)</div>
        <div class="inline-block-fix">
          <p>※ For those using data only, passport information verification is not required.</p><br>
          <p style="color: red;">※ A passport issued by the Republic of Korea cannot be used cannot use online passport
            information verification.</p><br>
          <p>Online passport information verification is available daily from 8:00 AM to 10:00 PM after passing through
            Korean immigration. </p><br>
          <p>
          ...
          <p>① Enter login information:<br>
            Rental contract number / eSIM 010 phone number (This information will be provided on your QR code email)</p>
          <br>

          <p>② Enter your passport information:<br>
            Last name / First name / Passport number / Date of birth / Nationality (must match the information on your
            passport)
          </p>
        </div>
        ...
        <div class="inline-block-fix">
          <p style="color: red;">※ Only customers who have completed passport information verification can charge
            online.</p><br>
        ...
        <div class="section-title">
          ...
          please send an email to contact@yconnectkorea.com with your order details and inquiry, and we will respond
          promptly.<br>
